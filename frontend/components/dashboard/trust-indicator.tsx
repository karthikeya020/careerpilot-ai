  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-3 gap-3 text-center">
        ...
        <div>
          <p className="text-lg font-semibold text-foreground">{trust.total_evidence_count}</p>
          <p className="text-[11px] text-muted">Evidence items</p>
        </div>
        <div>
          <p className="text-lg font-semibold text-foreground">{trust.formula_version}</p>
